            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('news')); ?>" class="btn btn-success">Refresh</a>
                        <a href="<?php echo e(route('news.add')); ?>" class="btn btn-primary">Add News</a>
                    </div>
                </div>
...
$(function() {
    $('#list-news').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route("list.news")); ?>',
        columns: [
