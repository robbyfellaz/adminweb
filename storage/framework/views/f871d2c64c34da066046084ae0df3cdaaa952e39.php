            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('news')); ?>" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('tag')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-angle-right"></i>
                                        <p>News Tag</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('trendingtag')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-angle-right"></i>
                                        <p>Trending Tag</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('headline')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-angle-right"></i>
                                        <p>Headline</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('recommended')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-angle-right"></i>
                                        <p>Recommended</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('breakingnews')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-angle-right"></i>
                                        <p>Breaking News</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('contactus')); ?>" class="nav-link">
                                        <i class="nav-icon fas fa-angle-right"></i>
                                        <p>Contact Us</p>
                                    </a>
                                </li>
