            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('recommended')); ?>" class="btn btn-success">Refresh</a>
                        <a href="<?php echo e(route('recommended.add')); ?>" class="btn btn-primary">Add Recommended</a>
                    </div>
                </div>
...
$(function() {
    $('#list-recommended').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route("list.recommended")); ?>',
        columns: [
