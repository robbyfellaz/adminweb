    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form class="form-vertical" method="post" enctype="multipart/form-data" action="<?php echo e(route('news.store')); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="categoryId">
                                        <?php $__currentLoopData = $categoryCombo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryComboItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($categoryComboItem->id); ?>"><?php echo e($categoryComboItem->title); ?></option>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control <?php echo e($errors->has('synopsis') ? ' is-invalid' : ''); ?>" name="synopsis" placeholder="Add Synopsis" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group date form_datetime" data-date="<?php echo e($dateNow); ?>">
                                            <input type="text" class="form-control <?php echo e($errors->has('synopsis') ? ' is-invalid' : ''); ?>" name="datePublish" placeholder="Add Date Publish" required>
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <option value="">-</option>
                                            <?php $__currentLoopData = $userCombo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userComboItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($userComboItem->id); ?>"><?php echo e($userComboItem->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control <?php echo e($errors->has('imageinfo') ? ' is-invalid' : ''); ?>" name="imageinfo" placeholder="Add Image Info">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input <?php echo e($errors->has('image') ? ' is-invalid' : ''); ?>" id="image" name="image" required>
