    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form class="form-vertical" method="post" enctype="multipart/form-data" action="{{route('news.update', $news->id)}}">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" placeholder="Add Title" value="{{ $news->title }}" required>
                                        @if($errors->has('title'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="categoryId">
                                        @foreach($categoryCombo as $categoryComboItem)
                                            <option value="{{ $categoryComboItem->id }}" {{ $categoryComboItem->id == $news->categoryId ? 'selected' : '' }}>{{ $categoryComboItem->title }}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control {{ $errors->has('synopsis') ? ' is-invalid' : '' }}" name="synopsis" placeholder="Add Synopsis" value="{{ $news->synopsis }}" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="select2" multiple="multiple" data-placeholder="Select news tags" name="tagId[]" style="width: 100%;" required>
                                            ...
                                            <option value="{{ $tagComboItem->id }}" {{ in_array($tagComboItem->id, json_decode($news->tagId)) ? 'selected' : '' }}>{{ $tagComboItem->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group date form_datetime" data-date="{{ $dateNow }}">
                                            <input type="text" class="form-control {{ $errors->has('synopsis') ? ' is-invalid' : '' }}" name="datePublish" placeholder="Add Date Publish" value="{{ $news->datePublish }}" required>
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <option value="">-</option>
                                            @foreach($userCombo as $userComboItem)
                                                <option value="{{ $userComboItem->id }}" {{ $userComboItem->id == $news->editorId ? 'selected' : '' }}>{{ $userComboItem->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="isHeadline" id="isHeadline" {{ $news->isHeadline === "Yes" ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <option value="">-</option>
                                            @foreach($userCombo as $userComboItem)
                                                <option value="{{ $userComboItem->id }}" {{ $userComboItem->id == $news->reporterId ? 'selected' : '' }}>{{ $userComboItem->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="isEditorPick" id="isEditorPick" {{ $news->isEditorPick === "Yes" ? 'checked' : '' }}>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2" style="width: 100%;" name="photographerId">
                                            <option value="">-</option>
                                            @foreach($userCombo as $userComboItem)
                                                <option value="{{ $userComboItem->id }}" {{ $userComboItem->id == $news->photographerId ? 'selected' : '' }}>{{ $userComboItem->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="status" id="status" {{ $news->status === "Active" ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control {{ $errors->has('imageinfo') ? ' is-invalid' : '' }}" name="imageinfo" placeholder="Add Image Info" value="{{ $news->imageinfo }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    ...
                                    @endif
                                    <textarea class="textarea is-invalid" placeholder="Add Content" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="content">{{ $contentHtml }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
